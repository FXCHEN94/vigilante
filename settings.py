...
ROOMS = [
    ...
    {   'name': 'Leader_Dominance',
        'display_name': 'Public Goods Room',
        'participant_label_file':'_rooms/study_label.txt'}
]
...
SECRET_KEY = 'c)8#rgt_pf4t1hc^b0)@4s4ko8cj*9p2q4gs%a&d=nzq)0^0v#'
